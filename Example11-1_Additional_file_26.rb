# Example 11-1: Centralized query for Melanoma (umls:C0025202) using the uberonRDF-KGX [2 min 23 sec/100 rows, 10 min 26 sec/all rows] 
...
WHERE {
  GRAPH <http://metadb.riken.jp/db/uberonRDF_broader_fromKGX> {
    ?lower_anatomicalEntity <http://purl.org/rbrc/resource/broader>*  obo:UBERON_0002097.
    }  
